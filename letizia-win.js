...
client.on('ready', async () => {
    ...
    keepAlive(); // Evita que el proceso termine
});
...
// Función para mantener el proceso vivo y evitar que el bot se cierre
const keepAlive = () => {
    console.log("🟢 Bot corriendo. Presiona Ctrl + C para salir.");
